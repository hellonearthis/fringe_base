...
const htmlLines = [
    ...
    '            header.innerHTML = "<h3>Show Schedule Timeline <small style=\'font-weight:400; color:var(--text-dim); font-size:0.8rem\'>(Drag from bottom to zoom into a time range)</small></h3>";',
